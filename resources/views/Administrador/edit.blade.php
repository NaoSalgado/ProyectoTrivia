...
@section('content')
  <div class="form-center-container">
    <div class="form-container text-center">
      ...
      <form method="post" action="{{ route('administradores.update', ['administrador' => $administrador]) }}" >
        @method('PATCH')
        @csrf
          ...
          <div class="form-floating mb-3 w-100">
            ...
            value="{{old('nombre',$administrador->contrasena)}}"placeholder="Ingrese una contraseña">
